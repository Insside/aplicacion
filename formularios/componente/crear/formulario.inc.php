...
$amc = new Aplicacion_Modulos_Componentes();
...
$valores['peso'] = "00";
$valores['herencia'] =Request::getValue("herencia");
...
$f->campos['herencia'] = $amc->combo("herencia", $valores['herencia']);
...
/** Celdas * */
$f->celdas["componente"] = $f->celda("Componente:", $f->campos['componente'], "", "w100px");
...
$f->celdas["creador"] = $f->celda("Usuario (Creador):", $f->campos['creador'], "", "w100px");
/** Filas * */
...
// JavaScript
$f->JavaScript("MUI.resizeWindow($('".$f->ventana."'), {width: 640, height:360, top: 0, left: 0});");
