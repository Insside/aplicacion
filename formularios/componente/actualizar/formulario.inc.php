...
$f->campos['permiso']=$f->getSelect(array("id" =>"permiso","values" => $pgl,"label" => "permiso","option" => "permiso","onChange" => "changePermiso".$f->id."()","selected"=>$valores['permiso']));
