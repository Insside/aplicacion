...
$v['subclase'] = Request::getValue("_subclase");
$v['etiqueta'] = Request::getValue("_etiqueta");
$v['estado'] = Request::getValue("_estado");
$v['css'] = Request::getValue("_css");
$v['css_firefox'] = Request::getValue("_css_firefox");
$v['css_chrome'] = Request::getValue("_css_chrome");
$v['css_iexplorer'] = Request::getValue("_css_iexplorer");
$v['css_opera'] = Request::getValue("_css_opera");
$v['descripcion'] = Request::getValue("_descripcion");
$v['version'] = Request::getValue("_version");
$v['fecha'] = Request::getValue("_fecha");
$v['hora'] = Request::getValue("_hora");
$v['creador'] = Request::getValue("_creador");
/** Campos * */
